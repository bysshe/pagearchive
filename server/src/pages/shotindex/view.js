        ...
        <div className="column-space full-height default-color-scheme">
          <div id="shot-index-header" className="header">
            ...
            <form onSubmit={ this.onSubmitForm.bind(this) }>
              ...
              <input type="search" id="search" ref="search" maxLength="100" placeholder="search my archives" defaultValue={this.state.defaultSearch} onChange={this.onChangeSearch.bind(this)} />
